    ...
    a(b).load(function() {
        ...
        _f: function() {
            ...
            this.h = a("<div>", {
                ...
                "class": "divider"
            }).appendTo(this.i))), this._g(this.l, ""), this.isMobile || (this.k = this.i.children(".country"), this.b.dropdownContainer ? this.dropdown = a("<div>", {
        ...
        _ac: function() {
            this.i.addClass("hide"), this.h.children(".arrow").removeClass("up"), a(c).off(this.ns), a("html").off(this.ns), this.i.off(this.ns), this.b.dropdownContainer && !this.isMobile && (a(b).off("scroll" + this.ns), this.dropdown.detach())
        },
        _ad: function(a, b) {
            var c = this.i,
                d = c.height(),
